 ...
 */
final readonly class AsyncCapability9
{
    /**
    ...
    {
        return AsyncCached::sequence([$this->first, $this->second, $this->third, $this->fourth, $this->fifth, $this->sixth, $this->seventh, $this->eighth, $this->ninth])->map(static function (array $values) use ($transform): mixed {
            /** @var array{T1, T2, T3, T4, T5, T6, T7, T8, T9} $values */
